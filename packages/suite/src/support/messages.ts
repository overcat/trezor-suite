...
export default defineMessages({
    ...
    TR_BIO_AUTH_SYSTEM_MESSAGE_WIN: {
        defaultMessage: 'Use your fingerprint or enter your PIN to access Trezor Suite.',
    ...
    TR_UDEV_DOWNLOAD_DESC: {
        defaultMessage:
            'In some cases, Linux users need to install udev rules to access their Trezor device. Install the following package and reconnect your Trezor.',
    ...
    TR_SECURITY_CHECK_HOLOGRAM: {
        defaultMessage:
            "Note that device packaging, including holograms and security seals, have been updated over time. You can verify packaging details <packaging>here</packaging>. \n\nEnsure that your device was purchased from either the official Trezor Shop or from one of <reseller>our trusted sellers</reseller>. Otherwise, there's a risk that your device might be a counterfeit. \n\nIf you suspect that your device isn't genuine,  <support>contact Trezor Support</support>.",
    ...
    TR_AUTO_EJECT_CONFIRMATION_DESCRIPTION: {
        defaultMessage:
            "Your wallets and balances won't be visible in Trezor Suite until you reconnect your device.",
    ...
    TR_TOKEN_UNRECOGNIZED_BY_TREZOR_TOOLTIP: {
        defaultMessage: "We don't recognize this token. It may be unsafe—proceed with caution.",
    ...
    TR_NFT_UNRECOGNIZED_BY_TREZOR_TOOLTIP: {
        defaultMessage: "We don't recognize this NFT. It may be unsafe—proceed with caution.",
    ...
    TR_RECOVER_SUBHEADING_TOUCH: {
        defaultMessage:
            "The entire wallet recovery process is completed using your Trezor's touchscreen.",
        description: 'Subheading in recover page. Basic info about recovery',
    ...
    TR_THP_INCORRECT_SECURITY_CODE: {
        ...
        defaultMessage: 'Incorrect security code. Try again with a new code.',
    },
    TR_THP_GET_NEW_CODE: {
    ...
    TR_ADDRESS_PHISHING_WARNING: {
        defaultMessage:
            'To prevent phishing attacks, verify the receive address on your Trezor. {claim}',
    ...
    TR_NO_TRANSPORT: {
        defaultMessage: 'Trezor Suite is having trouble connecting to your device.',
        description: '',
        id: 'TR_NO_TRANSPORT',
    },
    ...
    TR_YOU_WERE_DISCONNECTED_DOT: {
        defaultMessage:
            "You're offline. Some features will be available once you're connected again.",
    ...
    TR_YOUR_TREZOR_IS_NOT_BACKED_UP: {
        defaultMessage: "Your Trezor wallet isn't backed up.",
    ...
    TR_QUICK_ACTION_UPDATE_POPOVER_APP_DOWNLOADED: {
        ...
        defaultMessage: 'Trezor Suite downloaded a new update.',
    },
    ...
    TR_DEACTIVATE_TOKEN_BALANCE_WARNING: {
        ...
        defaultMessage: 'To deactivate {token}, first send its balance elsewhere.',
    },
    TR_ASSET_CODE: {
        id: 'TR_ASSET_CODE',
    ...
    RECEIVE_DESC_BITCOIN: {
        ...
        defaultMessage:
            "To receive any funds you need to get a fresh receive address. It's advised to always use a fresh address, as this prevents anyone else from tracking your transactions. You can reuse an address, but we recommend not doing so unless absolutely necessary.",
    },
    ...
    TR_FIRMWARE_REINSTALL_FW_DESCRIPTION: {
        ...
        defaultMessage:
            'Your device already has the latest firmware installed. You can reinstall it at any time if needed.',
    },
    ...
    IMAGE_VALIDATION_ERROR_PROGRESSIVE_JPG: {
        ...
        defaultMessage: "Progressive JPG image format isn't supported.",
    },
    ...
    RECIPIENT_IS_NOT_SET: {
        defaultMessage: "Address isn't set",
    ...
    AMOUNT_IS_NOT_SET: {
        defaultMessage: "Amount isn't set",
    ...
    AMOUNT_NOT_ENOUGH_CURRENCY_FEE: {
        defaultMessage: 'Insufficient {networkDisplaySymbol} to cover the transaction fee',
    ...
    LOCKTIME_IS_NOT_INTEGER: {
        ...
        defaultMessage: "Locktime isn't an integer",
    },
    LOCKTIME_IS_TOO_LOW: {
    ...
    TR_SELECT_RECOVERY_METHOD: {
        ...
        defaultMessage: 'Select wallet recovery method',
    },
    ...
    TR_CANCEL_TX_NOTICE: {
        ...
        defaultMessage:
            'Once the transaction is canceled successfully, your funds (minus the transaction fee) will be returned to your account.',
    },
    TR_CANCEL_TX_FEE: {
        id: 'TR_CANCEL_TX_FEE',
    ...
    TR_TRANSACTIONS_SEARCH_PRO_TIP: {
        ...
        defaultMessage:
            'Enhance your search by using logical operators like <span><, >, |, &, =, !=</span>',
    },
    TR_TRANSACTIONS_SEARCH_TIP_1: {
        id: 'TR_TRANSACTIONS_SEARCH_TIP_1',
        defaultMessage:
            'Tip: Search for transaction IDs, addresses, tokens, labels, amounts, and dates.',
    },
    ...
    TR_TRANSACTIONS_SEARCH_TIP_3: {
        ...
        defaultMessage:
            'Tip: Search for exact amounts using the equal (=) symbol. For example <strong>= 0.01</strong> will show only transactions that have an amount of exactly 0.01.',
    },
    TR_TRANSACTIONS_SEARCH_TIP_4: {
        id: 'TR_TRANSACTIONS_SEARCH_TIP_4',
        defaultMessage:
            'Tip: Exclude an amount by using the exclamation mark and equal symbols together (!=). For example <strong>!= -0.01</strong> will show all transactions except the ones with an amount of -0.01.',
    },
    ...
    TR_TRANSACTIONS_SEARCH_TIP_7: {
        ...
        defaultMessage:
            'Tip: Exclude a date by using the exclamation mark and equal symbols together (!=). For example <strong>!= {lastYear}-12-14</strong> will show all transactions except the ones on December 14th, {lastYear}.',
    },
    TR_TRANSACTIONS_SEARCH_TIP_8: {
        id: 'TR_TRANSACTIONS_SEARCH_TIP_8',
        defaultMessage:
            'Tip: Display results matching at least one of multiple searches by grouping them with the OR operator (|). For example <strong>{lastYear}-11-30 | {lastYear}-12-01</strong> will show all transactions that occurred on the 30th of November or the 1st of December {lastYear}.',
    },
    ...
    TR_SKIP_ROUNDS_DESCRIPTION: {
        ...
        defaultMessage:
            'Skipping rounds makes it more difficult to trace your inputs, helping further obscure the origin of the funds.',
    },
    TR_MAX_MINING_FEE: {
    ...
    TR_BREAKING_ANONYMITY_CHECKBOX: {
        ...
        defaultMessage: "I understand that I'm compromising my anonymity.",
    },
    ...
    TR_BIO_AUTH_UNAVAILABLE_TOOLTIP: {
        ...
        defaultMessage: "Biometric authentication isn't available on your device.",
    },
    TR_VIEW_ALL: {
        id: 'TR_VIEW_ALL',
    ...
    TR_RECEIVE_ADDRESS_CONFIRMATION_HEADING: {
        ...
        defaultMessage: 'Before confirming on Trezor',
    },
    ...
    TR_AUTO_START_DESCRIPTION: {
        ...
        defaultMessage:
            'Start Trezor Suite automatically in the background when you log in to your computer.',
    },
    TR_SHOW_ON_TRAY: {
        id: 'TR_SHOW_ON_TRAY',
    ...
    TR_BLUETOOTH_CANNOT_OPEN_BLUETOOTH_SETTINGS_PERMISSIONS: {
        ...
        defaultMessage:
            'Unable to open permission settings. Go to Settings > Privacy & Security > Bluetooth to adjust permissions.',
    },
