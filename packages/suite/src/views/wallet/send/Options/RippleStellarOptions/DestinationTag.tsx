            ...
            {destinationEnabled ? (
                <>
                    <Input
                        ...
                        maxLength={networkType === 'ripple' ? formInputsMaxLength.xrpDestinationTag : formInputsMaxLength.stellarTextMemo}
                ...
                <Banner variant="warning" icon="warning">
                    <Translation id="DESTINATION_TAG_BANNER_SEND" values={{ network: name }} />
                </Banner>
            )}
        </Column>
    );
